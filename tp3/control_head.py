...
It adds a frame corresponding to the robot gaze, and provides a multi-objective control
loop where the robot servo both its gripper and its gaze in two hierachized tasks.
"""
...
viz.addSphere("ball", 0.05, [0.8, 0.1, 0.5, 0.8])
